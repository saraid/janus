(function() {
  ...
  List = (function(_super) {
    ...
    List.prototype.watchAll = function(deep) {
      var model, react, uniqSubmodels, varying, watchModel, _i, _len, _ref,
        _this = this;
      ...
      if (deep) {
        ...
        this.on('moved', react);
        uniqSubmodels = this.map(function(elem) {
          return elem;
        }).filter(function(elem) {
          return elem instanceof Model;
        }).uniq();
        _ref = uniqSubmodels.list;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          model = _ref[_i];
          watchModel(model);
        }
