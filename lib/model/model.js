(function() {
  ...
  Model = (function(_super) {
    ...
    Model.prototype.watchAll = function(deep) {
      var model, uniqSubmodels, varying, watchModel, _i, _len, _ref1,
        _this = this;
      ...
      varying.listenTo(this, 'anyChanged', function() {
        return varying.setValue(_this, true);
      });
      if (deep) {
        watchModel = function(model) {
          return varying.listenTo(model, 'anyChanged', function() {
            model.watchAll(deep).react(function() {
              return varying.setValue(_this, true);
            });
            return varying.setValue(_this, true);
          });
        ...
        uniqSubmodels.on('removed', function(oldModel) {
          return varying.unlistenTo(oldModel.watchAll(deep));
        });
      }
      return varying;
    };
    ...
    Model.prototype._emitChange = function(key, newValue, oldValue) {
      ...
      if (newValue instanceof Reference) {
        ...
        if ((_ref1 = this._watchSubreferences$) == null) {
          this._watchSubreferences$ = (function() {
            var uniqSubreferences, watchReference;

            watchReference = function(ref) {
              var resolveReference;

              resolveReference = function(model) {
                if (model instanceof Model && __indexOf.call(uniqSubreferences, ref) >= 0) {
